    ...
    <section className="bg-black text-white px-5 py-20 md:py-32">
      <div className="lettersc container mx-auto grid md:grid-cols-2 items-center justify-center md:justify-between relative">
        ...
        <div className={`icons relative translate-x-20 -translate-y-28 cursor-pointer   `}>
            <a href="https://github.com/SaiSriramKurapati"target="_blank" rel="noreferrer" className='pr-6'>
              <FontAwesomeIcon
              icon={faGithub}
              color="#37e4db"
            ...
            <a href="http://www.linkedin.com/in/sai-sriram-kurapati-660660149/" target="_blank" rel="noreferrer" className='pr-6'>
              <FontAwesomeIcon
              icon={faLinkedin}
              color="#37e4db"
